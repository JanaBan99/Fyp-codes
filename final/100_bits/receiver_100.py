...
def checkBits( bit_stream_2):
    transmittedBits= '101011001010110011010100110010101101001101011001010100110101010011010110010110100110101001011010110'
    ...
    differences = sum(1 for b1, b2 in zip(transmittedBits, bit_stream_2) if b1 != b2)
...
def main():
    ...
    timer_edge_detection.init(period=1, mode=Timer.PERIODIC, callback=edge_detection)
